    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <x-nav-link href="/blog" :active="Str::contains(request()->segment('1'), 'blog') ">Blog</x-nav-link>
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            ...
            <div class="ml-3">
                <div class="text-base/5 font-medium text-white">Zainul Anwar</div>
                <div class="text-sm font-medium text-gray-400">zainul@kosme.co.id</div>
            </div>
            </div>
